    ...
    def simulate(self):
        ...
        for i in range(0, pre_simulation.parameters()[0] + 1):
            ...
            if self.sim_type == 'semi_analytical':
                ...
                mag_field = fields.B_field(40, 45, 0.1, 0.1, self.filename, input_par2, input_par1, inn_prop['voltage'][0], inn_prop['flux'][0]
        ...
        # plt.xlabel('Inner Coil Position [mm]')
        # plt.ylabel('Rel error (fit - actual)*100/actual [%]')
        ...
        if self.save:
            np.savez_compressed(self.filename, Design_parameters = input_par2, Input_parameters = input_par1, coil_config_parameters = coil_con, Innercoil_config = position.inncoil(),
