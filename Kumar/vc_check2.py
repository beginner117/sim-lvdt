...
class Modelling():
    ...
    femm.mi_setgroup(6)
    femm.mi_clearselected()
    femm.mi_addblocklabel(yoke.block1()[2]/2, yoke.block1()[3] + (block.b1_h * 0.5))
    femm.mi_selectlabel(yoke.block1()[2]/2, yoke.block1()[3] + (block.b1_h * 0.5))
...
class Results():
    ...
    plt.plot(np.array(modelled.InnCoil_Positions), np.array(modelled.Magnet_Forces_c), "o--", label = "Inn_coil")
    plt.plot(np.array(modelled.InnCoil_Positions), np.array(modelled.Magnet_Forces1), "o--", label = "magnet")
    plt.ylabel('Magnet Force [N]')
    plt.xlabel('Inner Coil Position [mm]')
    plt.legend()
    #plt.savefig("mf1.png")
    #shutil.move("mf1.png", r"C:\Users\kumar\OneDrive\Desktop\pi")
    #plt.show()
