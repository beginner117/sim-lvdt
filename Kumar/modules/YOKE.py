    ...
    def simulate(self):
        ...
        if self.default == 'yes':
            geo = design.Geometry(inn_ht=value[self.design_type]["inn_ht"], inn_rad=value[self.design_type]["inn_rad"], inn_layers=value[self.design_type]["inn_layers"], inn_dist=value[self.design_type]["inn_dist"],
                                  ...
                                  , innlow_ht=value[self.design_type]["lowinn_ht"], mag_ht= value[self.design_type]["mag_ht"], mag_innrad=value[self.design_type]["mag_inn"], mag_outrad=value[self.design_type]["mag_out"],
                                  mag_ver_shi=value[self.design_type]["mag_ver_shi"])
            ...
            input_par = {'inn_ht': 18, 'lowinn_ht': 23, 'inn_rad': 21, 'inn_layers': 6, 'inn_dist': 60.5, 'out_ht': 13.5,
                        'out_rad': 31.5, 'out_layers': 5, 'out_dist': 14.5, 'mag_len': 0, 'mag_inn': 31.65,'mag_out': 44.45, 'ver_shi': 0}
            geo = design.Geometry(inn_ht=input_par['inn_ht'],  inn_rad=input_par['IC_radius'],
                                  ...
                                  mag_ht=input_par['mag_len'], mag_innrad=input_par['mag_inn'],mag_outrad=input_par['mag_out'],
                                  ver_shi=input_par['ver_shi'], innlow_ht=input_par['lowinn_ht'])
        ...
        Low_Inncoil_NrWind_p_Layer = (geo.inncoil()[0]) / (wire.prop_inn()[0] + wire.prop_inn()[1] * 2)
        Low_Inncoil_NrWindings = Low_Inncoil_NrWind_p_Layer * geo.inncoil()[2]
