...
class Analysis:
    ...
    def simulate(self):
        ...
        input_par1 = {'TotalSteps_StepSize_Offset' : self.sim_range, 'uppercoil Diameter_Insulation_Wiretype':wire.prop_out(), 'innercoil Diameter_Insulation_Wiretype': wire.prop_inn(),
        ...
        if self.default=='yes':
            ...
            input_par2 = {'IC_height':18, 'IC_radius':21, 'IC_layers':6, 'IC_distance':0, 'OC_height':13.5, 'OC_radius':31.5, 'OC_layers':self.parameter1, 'OC_distance':31.5, 'mag_len':0, 'mag_dia':0, 'ver_shi':0}
        ...
        if self.save:
            np.savez_compressed(self.filename, Design = input_par2, Input_parameters = input_par1,  IC_positions = inn_prop['Inncoil_position'], IC_voltages = inn_prop['Inncoil_voltage'],
