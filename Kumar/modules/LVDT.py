...
class Analysis():
    ...
    def simulate(self):
        ...
        if self.default=='yes':
            ...
            geo = design.Geometry(inn_ht=18, inn_rad=self.parameter1, inn_layers=6, inn_dist=0, out_ht=13.5, out_rad=31.5, out_layers=5, out_dist=14.5, mag_len=0, mag_dia=0, ver_shi=0)
        ...
        class Results():
            ...
            Norm_OutCoil_Signals = OutCoil_Signals / 0.02
