...
wire_types = {'30 AWG': [0.254, 0.0216,'30 AWG', 103.7/304800],
              ...
              '32 AWG_corrected_1': [0.2032, 0.0178+(0.0062/2),'32 AWG_corrected_1', 162 / 304800, 58, 1.68 * (10 ** (-8)), 1.256 * (10 ** (-6))],
              '32 AWG_corrected_2': [0.2032, 0.0178+(0.0202/2),'32 AWG_corrected_2', 162 / 304800, 58, 1.68 * (10 ** (-8)), 1.256 * (10 ** (-6))],
