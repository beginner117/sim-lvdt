...
# wire diameter, insulation thickness, wire type, electrical conductivity, resistivity(ohm*m), mag_perm(H/m)
    def prop_out(self):
        ...
        # return [0.2032+0.0062, 0.0178, "32 AWG_corrected_1", 162/304800]
            return [0.2032, 0.0178 + (0.0062 / 2), "32 AWG_corrected_1", 162 / 304800, 58, 1.68 * (10 ** (-8)),
                1.256 * (10 ** (-6))]
        if self.outcoil_material == "32 AWG_corrected_2":
        # return [0.2032+0.0202, 0.0178, "32 AWG_corrected_2", 162/304800]
            return [0.2032, 0.0178 + (0.0202 / 2), "32 AWG_corrected_2", 162 / 304800, 58, 1.68 * (10 ** (-8)),
                1.256 * (10 ** (-6))]
