...
class Modelling():
    ...
    femm.mi_clearselected()
    print("endpoint is ", yoke.block1()[2])
...
class Results():
    ...
    #plt.plot(modelled.InnCoil_Positions, modelled.Magnet_Forces1, 'o-')
    #plt.plot(modelled.InnCoil_Positions, modelled.Magnet_Forces2, 'o-')
    plt.plot(np.array(modelled.InnCoil_Positions), np.array(modelled.Magnet_Forces_m), "o--", label = "magnet")
    plt.plot(np.array(modelled.InnCoil_Positions), np.array(modelled.Magnet_Forces_c), "o--", label = "inncoil")
    plt.plot(np.array(modelled.InnCoil_Positions), np.array(modelled.Magnet_Forces1), "o--", label = "block1")
    plt.plot(np.array(modelled.InnCoil_Positions), np.array(modelled.Magnet_Forces2), "o--", label="block2")
    plt.plot(np.array(modelled.InnCoil_Positions), np.array(modelled.Magnet_Forces3), "o--", label="block3")
    plt.plot(np.array(modelled.InnCoil_Positions), np.array(modelled.tot_mag), "o--", label="total")
    plt.ylabel('Force [N]')
    plt.xlabel('Inner Coil Position [mm]')
    plt.legend()
    #plt.savefig("mf2.png")
    #shutil.move("mf2.png", r"C:\Users\kumar\OneDrive\Desktop\pi")
    plt.show()

    #plt.plot(modelled.InnCoil_Positions, modelled.Magnet_Forces1 / max(modelled.Magnet_Forces1) * 100, 'o-')
    #plt.plot(modelled.InnCoil_Positions, modelled.Magnet_Forces2 / max(modelled.Magnet_Forces2) * 100, 'o-')
